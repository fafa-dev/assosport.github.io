...
class SwiperBC {
  constructor(container, config) {
    ...
    container.closest('.elementor-widget-wrap').addClass('e-swiper-container'); // In case of a legacy behaviour the constructor should return a new Swiper instance instead of a Promise.
