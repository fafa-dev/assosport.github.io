...
export class PrestoEmailOverlay {
  ...
  render() {
    var _a;
    return (h("presto-email-overlay-controller", { ended: this.ended, currentTime: this.currentTime, videoId: this.videoId, duration: this.duration, direction: this.direction, emailCollection: (_a = this.preset) === null || _a === void 0 ? void 0 : _a.email_collection, i18n: this.i18n }));
  }
